...
class CSDGUI:
    def __init__(self, master):
        ...
        # File area
        self.file = tk.Text(master, height=25, wrap="none")
        ...
        # Scrollbars
        yscrollfile = tk.Scrollbar(self.file, orient=tk.VERTICAL, command=self.file.yview)
        self.file.configure(yscrollcommand=yscrollfile.set)
        yscrollfile.pack(side=tk.RIGHT, fill=tk.Y)
